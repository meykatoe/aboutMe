        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900" x-data="{ copied: false }">
                    <h3 class="font-semibold text-lg mb-4">分享你的個人頁面</h3>

                    <div class="flex flex-col sm:flex-row gap-6">
                        <canvas data-qrcode-url="{{ $profileUrl }}" class="shrink-0"></canvas>

                        <div class="flex-1 min-w-0">
                            <label for="profile-url" class="block text-sm font-medium text-gray-700 mb-1">你的公開網址</label>
                            <div class="flex gap-2">
                                ...
                                <x-secondary-button
                                    ...
                                    "
                                >
                                    <span x-show="!copied">複製連結</span>
                                    <span x-show="copied">已複製！</span>
                                </x-secondary-button>
                            </div>
                            <p class="mt-2 text-sm text-gray-500">分享此連結或掃描 QR code，讓其他人快速造訪你的個人頁面。</p>
                        </div>
                    </div>
                </div>
            </div>
